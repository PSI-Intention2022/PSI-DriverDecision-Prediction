...
def get_opts():
    ...
    parser.add_argument('--video_splits', type=str, default='PSI2.0_split.json',
                        help='video splits, [PSI1.0_split | PSI2.0_split]')
    ...
    parser.add_argument('--traj_loss', type=list, default=['mse'],
                        help='loss for traj output. [bce | mse | cross_entropy]')
    parser.add_argument('--driving_loss', type=list, default=['cross_entropy'],
                        help='loss for driving output. [cross_entropy]')
