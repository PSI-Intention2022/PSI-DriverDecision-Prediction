...
from train import train_driving
from test import predict_driving
from utils.get_test_gt import get_test_driving_gt
from utils.log import RecordResults
from utils.evaluate_results import evaluate_driving


def main(args):
    writer = SummaryWriter(args.checkpoint_path)
    recorder = RecordResults(args, intent=False, traj=False, driving=True, reason=False)
    ''' 1. Load database '''
    ...
    # ''' 4. Evlaute '''
    # test_gt_file = './test_gt/test_driving_gt.json'
...
if __name__ == '__main__':
    ...
    # Task
    args.task_name = 'driving_decision'
    # intent prediction
    ...
    # Model
    args.model_name = 'reslstm_driving_global'  # LSTM module, with bboxes sequence as input, to predict intent
